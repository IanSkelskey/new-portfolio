...
const ProjectDetail = ({ projects, skillsData }) => {
  ...
  const projectIcon = project.icon ? <IconRenderer icon={project.icon} /> : null;
  ...
  return (
    <DetailWrapper
      ...
      heroImage={project.thumbnail || `https://via.placeholder.com/1200x600?text=${encodeURIComponent(project.title)}`}
